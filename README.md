...
> 🤖 **Learning project:** This project was built to learn backend development with Java & Spring Boot. The frontend was generated with AI (Claude by Anthropic) to allow focus on backend logic without getting blocked by UI work.
...
| Deploy | GitHub Pages |
| Generated by | Claude (Anthropic) — AI-assisted for learning & testing |

> **Note:** The frontend was generated with AI (Claude by Anthropic) to keep the focus on learning backend development. It covers all API endpoints with a functional UI — auth flows, game search, library management, status and rating updates — without spending time on manual frontend work.
...
└── docs/                             ← Frontend (GitHub Pages, AI-generated)
...
This project was built as a **learning exercise** to understand backend development with Java, Spring Boot, PostgreSQL, and REST API design.

**Claude** by [Anthropic](https://anthropic.com) was used in two ways:
- **Frontend generation** — the entire `docs/` UI was AI-generated so that all backend endpoints could be tested through a real interface without spending time on manual frontend work
- **Learning assistance** — AI was used as a study companion during backend development, helping understand concepts, debug issues, and explore Spring Boot patterns

The backend architecture, database schema, API design, and Spring Boot implementation are the core learning outcome of this project.
